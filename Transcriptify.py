...
def extract_themes_goals_challenges_painpoints(summary, model, progress_bar):
    prompts = {
        ...
        "information concepts": "Identify and list the key information concepts / business objects mentioned in the summary",
        "stakeholders: "Identify the stakeholders and/or organisations mentioned in the summary:",
